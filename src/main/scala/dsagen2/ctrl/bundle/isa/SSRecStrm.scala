...
/** Parsed bundle of Recurrence Stream instantiation command
  */
class SSRecStrm extends SSISABundle {
  /* ---------- Hardware Fields ---------- */
  ...
  // CPU source register 1 that provides encoded parameter of recurrence stream
  // inst[19:15]
  ...
  // CPU destination register, not used in recurrence stream instantiation command
  // inst[11:7]
  val cpuRd: UInt = UInt(5.W)

  // Opcode
  // inst[6:0], should be 3, 6, 3
