...
class FMul_D64_IO extends Bundle {
  // Clock
...
class FMul_D64(val stage: Int = 5) extends BlackBox with HasBlackBoxResource {
  val moduleName: String = s"FMul_D64_${stage}stage"

  override def desiredName: String = moduleName

  val io: FMul_D64_IO = IO(new FMul_D64_IO)
