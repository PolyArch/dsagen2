...
/** Parsed bundle of Stream Specialization Synchronization Instruction
  */
class SSWait extends SSISABundle {
  ...
  // CPU Register Number that provides the encoded information for synchronization
  // inst[19:15]
